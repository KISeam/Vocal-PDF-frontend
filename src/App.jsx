    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
      <div className="max-w-4xl w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-blue-500 p-8 text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">PDF to Speech Converter</h1>
          <p className="text-blue-100 max-w-xl mx-auto">
            Transform your PDF documents into spoken words. Upload, select pages, and listen to your content.
          </p>
        </div>
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="mb-8">
            ...
            {isUploading && (
              <div className="mt-4 flex items-center justify-center">
                ...
                <span className="ml-3 text-blue-600 font-medium">Processing your document...</span>
              </div>
            )}
            ...
            <button 
              ...
              className={`w-full mt-6 py-3 rounded-xl text-white font-medium transition-all ${!file || isUploading ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 cursor-pointer shadow-md hover:shadow-lg'}`}
            >
              Analyze Document
            </button>
          </div>
          ...
          {totalPages > 0 && (
            <div className="mb-8 bg-gray-50 rounded-xl p-6 shadow-sm border border-gray-100">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                <div>
                  <h2 className="text-xl font-semibold text-gray-800">Document Controls</h2>
                  <p className="text-gray-600 text-sm mt-1">Select pages to preview and listen</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Select Pages</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Speech Controls</label>
                  <div className="flex space-x-3">
                    <button
                      onClick={startSpeech}
                      disabled={isPlaying || !previewText}
                      className={`flex-1 flex items-center justify-center px-4 py-3 rounded-xl font-medium transition-all ${isPlaying || !previewText ? 'bg-gray-200 text-gray-500 cursor-not-allowed' : 'bg-green-600 text-white hover:bg-green-700 cursor-pointer shadow-md hover:shadow-lg'}`}
                    >
          ...
          <div className="text-center text-gray-500 text-sm pt-4 border-t border-gray-100">
            <p>PDF to Speech Converter v1.0 • Securely process your documents</p>
          </div>
        </div>
      </div>
    </div>
